...
function Kelp(pos) {
  ...
  this.size = new Vector(0.5, 0.7);
  this.wobble = Math.random() * Math.PI * 14;
}
Kelp.prototype.type = "kelp";
...
var wobbSpeed = 5, wobbDist = 0.2;

Kelp.prototype.act = function(step) {
  this.wobble += step * wobbSpeed;
  var wobbPos = Math.cos(this.wobble) * wobbDist;
